...
$order = $conn->query("SELECT o.*,concat(c.firstname,' ',c.lastname, ' – ', c.contact) as client FROM `orders` o inner join clients c on c.id = o.client_id where o.id = '{$_GET['id']}' ");
if($order->num_rows > 0){
...
<div class="modal-footer">
    ...
    <a class="btn btn-flat btn-default" href="?page=orders">Close</a>
</div>
<?php if(isset($_GET['view'])): ?>
<style>
