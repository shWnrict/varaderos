	...
	<div class="card card-outline card-primary">
		...
		<div class="card-footer">
			<div class="col-md-12 d-flex justify-content-between">
				<div class="row">
					<a class="btn btn-sm btn-success" href="?page=user">My Account</a>
					<a class="btn btn-sm btn-info ml-2" href="<?php echo base_url ?>">Go to Website</a>
				</div>
				<!-- Add the button for changing username and password -->
				<div class="row">
